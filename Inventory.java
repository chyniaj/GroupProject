...
public class Inventory
{
     ...
     *
     * @return numParts number of parts in ArrayList
     */
     ...
     */
    public static void updateWarehouseDB(Inventory inventory, Warehouse warehouse, int warehouseNumParts){

            if (warehouseNumParts == 0){
                for(int k =0; k<inventory.getInventory().size(); k++){
                    BikePart part = inventory.getInventory().get(k);
                ...
                for (int i=0; i<inventory.getInventory().size(); i++){
                    ...
                    if(temp.equalsIgnoreCase(temp2)){ //be aware of lower or uppercase AND TRIM!!!
                    ...
                    else if(!(temp.equalsIgnoreCase(temp2)) && i == warehouse.getWarehouse().size()){
